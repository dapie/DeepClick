      ...
      <div class="modal-content">
        <form class="box" v-on:submit.prevent="register()">
          ...
          <figure class="image container is-96x96">
            <img src="~assets/img/thinking-face.png" alt="" />
          </figure>
          ...
          <div class="field">
            ...
            <div class="control has-icons-left">
              <input
                class="input"
                :class="{ 'is-danger': nameError, 'is-primary': !nameError }"
                type="text"
            ...
            <transition name="fade">
              <p class="help is-danger" v-if="nameError">
                {{ this.nameError }}
              </p>
            </transition>
          </div>
          ...
          <div class="field">
            <div class="control has-icons-left">
              <input
                ...
                :class="{ 'is-danger': confError, 'is-primary': !confError }"
                @input="checkPass()"
            ...
            <transition name="fade">
              <p class="help is-danger" v-if="confError">
                {{ this.confError }}
              </p>
            </transition>
          </div>
    ...
    checkPass() {
      this.passError =
        this.password.length >= 8
          ? ""
          : "Пароли должен содержать минимум 8 символов";
      this.confError =
        this.password === this.confirmation ? "" : "Пароли не совпадают";
    },
    checkName() {
